...
export default function EnrollmentCard() {
  ...
  const isPoomsae = useMemo(() => {
    ...
    const hasWeightField =
      "weight_name" in enroll ||
      "weight_category" in enroll ||
      "weight_category_name" in enroll ||
      "weight_category_display" in enroll;

    const hasWeightValue =
      (enroll.weight_name && enroll.weight_name !== "—") ||
      enroll.weight_category_name ||
      enroll.weight_category_display ||
      enroll.weight_category?.name ||
      enroll.weight_category?.title;
  ...
  const categoryValue = isPoomsae ? poomsaeStyleValue : weightCategoryValue;
